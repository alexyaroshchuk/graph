...
function mouseMoveEvent(event) {
    ...
    var xFieldD = document.getElementById("xFieldD");
    var yFieldD = document.getElementById("yFieldD");

    xFieldD.value = pointD.x;
    yFieldD.value = pointD.y;
}
...
function render() {
    ...
    drawLine(pointC.toContextCoord(), pointD.toContextCoord());
    drawPoint(pointC.toContextCoord());
    drawPoint(pointD.toContextCoord());
}
...
function inputValue(id) {
    ...
    switch (id) {
        ...
        case "yFieldB":
            ...
            case "xFieldC":
            {
                pointC.x = parseFloat(field.value);
                break;
            }
        case "yFieldC":
            {
                pointC.y = parseFloat(field.value);
                break;
            }
        case "xFieldD":
            {
                pointD.x = parseFloat(field.value);
                break;
            }
        case "yFieldDS":
            {
                pointD.y = parseFloat(field.value);
                break;
            }
    }
}